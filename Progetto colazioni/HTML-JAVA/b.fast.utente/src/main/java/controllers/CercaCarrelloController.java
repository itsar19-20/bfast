...
@WebServlet("/CercaCarrello")
public class CercaCarrelloController extends HttpServlet {
	 ...
	 */
	public CercaCarrelloController() {
		super();
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
			...
			Contiene or = c.cerca(request.getParameter("ordine"), request.getParameter("nome"));
			if(or!=null) {
